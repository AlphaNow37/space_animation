use super::{combinators::{TimeMod, TimeMul, TimeOffset, TimeSin, TimeLea}, world::World};
...
macro_rules! new_typed_variator {
    (
        ...
        impl<$($gen: Variator$(<Item=$ty>)?),*> crate::world::variator::Variator for $name<$($gen),*> $(where $($clause)*)? {
            type Item=$out;
